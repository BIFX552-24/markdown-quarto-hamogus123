...
This page is copied from <https://rpubs.com/moeransm/intro-iris> with modifications for learning purposes only.
...
`{# arrange()} newCol <- arrange(newCol, petal.width) head(newCol)`
